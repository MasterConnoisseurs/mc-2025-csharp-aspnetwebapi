...
public class PostPolicyDeductiblesTests
{
    ...
    public PostPolicyDeductiblesTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "PostPolicyDeductibles"
            }
        };
    ...
    [Fact]
    public async Task PostPolicyDeductibles_ReturnsOk()
    {
        // Arrange
        const long scopedIdentity = 1;
        SetUserClaims();
        var request = new PostPolicyDeductibles()
        {
            PolicyId = 1,
            PolicyTypeId = 1,
            DeductiblesId = 1,
        ...
        _mockTransactionV1Service.Setup(s => s.PostPolicyDeductibles(It.IsAny<object>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((object _, CancellationToken _) => TransactionResult<PostId>.Success(new PostId { Id = scopedIdentity }));

        // Act
        var result = await _controller.PostPolicyDeductibles(request);
    ...
    [Fact]
    public async Task PostPolicyDeductibles_ReturnsBadRequest_WhenValidationFails()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyDeductibles()
    ...
    [Fact]
    public async Task PostPolicyDeductibles_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyDeductibles()
    ...
    [Fact]
    public async Task PostPolicyDeductibles_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyDeductibles()
    ...
    [Fact]
    public async Task PostPolicyDeductibles_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyDeductibles()
    ...
    [Fact]
    public async Task PostPolicyDeductibles_ReturnsUnauthorized()
    {
        // Arrange
