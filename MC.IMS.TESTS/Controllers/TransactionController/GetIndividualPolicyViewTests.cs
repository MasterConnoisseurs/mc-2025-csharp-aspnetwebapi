...
public class GetIndividualPolicyViewTests
{
    ...
    public GetIndividualPolicyViewTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "GetIndividualPolicyView"
            }
        };
    ...
    [Fact]
    public async Task GetIndividualPolicyView_ReturnsOk_NoParameters()
    {
        // Arrange
        SetUserClaims();
        _mockTransactionV1Service.Setup(s => s.GetIndividualPolicyView(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
            .ReturnsAsync((long? id, string? referenceNumber, string? cocNumber, long? partnersId, long? clientsId, bool? issueStatus, string? policyBookingStatusId, string? cocStatusId, string? paymentStatusId, string? claimsStatusId, string? clientsInsuranceCustomerNo, CancellationToken _, int _, int _) =>
            {
                var filteredList = MockData.Transaction.View.IndividualPolicyView.IndividualPolicyViewList().Where(x =>
                    (id == null || x.Id == id) &&
                    ...
                    (clientsInsuranceCustomerNo == null || x.ClientsInsuranceCustomerNo == clientsInsuranceCustomerNo) &&
                ...
                return TransactionResult<IEnumerable<IndividualPolicyView>>.Success(filteredList);
            });

        // Act
        var result = await _controller.GetIndividualPolicyView(null, null, null, null, null, null, null, null, null, null, null);

        // Assert
        var statusCodeResult = Assert.IsType<OkObjectResult>(result);
        var returnData = Assert.IsAssignableFrom<PagedResponse<IEnumerable<IndividualPolicyView>>>(statusCodeResult.Value);
    ...
    [Fact]
    public async Task GetIndividualPolicyView_ReturnsOk_WithParameters()
    {
        // Arrange
        SetUserClaims();
        _mockTransactionV1Service.Setup(s => s.GetIndividualPolicyView(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
        ...
        // Act
        var result = await _controller.GetIndividualPolicyView(1, null, null, null, null, null, null, null, null, null, null);
    ...
    [Fact]
    public async Task GetIndividualPolicyView_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var resultData = TransactionResult<IEnumerable<IndividualPolicyView>>.Failure(new Exception("Service failed"));
        _mockTransactionV1Service.Setup(s => s.GetIndividualPolicyView(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
    ...
    [Fact]
    public async Task GetIndividualPolicyView_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        _mockTransactionV1Service.Setup(s => s.GetIndividualPolicyView(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
    ...
    [Fact]
    public async Task GetIndividualPolicyView_ReturnsUnauthorized()
    {
        // Arrange
