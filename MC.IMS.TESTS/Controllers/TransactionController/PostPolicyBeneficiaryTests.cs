...
public class PostPolicyBeneficiaryTests
{
    ...
    public PostPolicyBeneficiaryTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "PostPolicyBeneficiary"
            }
        };
    ...
    [Fact]
    public async Task PostPolicyBeneficiary_ReturnsOk()
    {
        // Arrange
        const long scopedIdentity = 10;
        SetUserClaims();
        var request = new PostPolicyBeneficiary()
        {
            PolicyId = 1,
            PolicyTypeId = 1,
            FirstName = "Maria",
        ...
        _mockTransactionV1Service.Setup(s => s.PostPolicyBeneficiary(It.IsAny<object>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((object _, CancellationToken _) => TransactionResult<PostId>.Success(new PostId { Id = scopedIdentity }));

        // Act
        var result = await _controller.PostPolicyBeneficiary(request);
    ...
    [Fact]
    public async Task PostPolicyBeneficiary_ReturnsBadRequest_WhenValidationFails()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyBeneficiary()
    ...
    [Fact]
    public async Task PostPolicyBeneficiary_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyBeneficiary()
    ...
    [Fact]
    public async Task PostPolicyBeneficiary_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyBeneficiary()
    ...
    [Fact]
    public async Task PostPolicyBeneficiary_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPolicyBeneficiary()
    ...
    [Fact]
    public async Task PostPolicyBeneficiary_ReturnsUnauthorized()
    {
        // Arrange
