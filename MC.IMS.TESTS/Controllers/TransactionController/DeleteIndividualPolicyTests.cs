...
public class DeleteIndividualPolicyTests
{
    ...
    public DeleteIndividualPolicyTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "DeleteIndividualPolicy"
            }
        };
    ...
    [Fact]
    public async Task DeleteIndividualPolicy_ReturnsOk()
    {
        // Arrange
        SetUserClaims();
        ...
        // Act
        var result = await _controller.DeleteIndividualPolicy(scopedIdentity);
    ...
    [Fact]
    public async Task DeleteIndividualPolicy_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 1;
    ...
    [Fact]
    public async Task DeleteIndividualPolicy_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 1;
    ...
    [Fact]
    public async Task DeleteIndividualPolicy_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 1;
    ...
    [Fact]
    public async Task DeleteIndividualPolicy_ReturnsUnauthorized()
    {
        // Arrange
