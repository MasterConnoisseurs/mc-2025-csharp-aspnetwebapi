...
public class PostGroupPolicyTests
{
    ...
    [Fact]
    public async Task PostGroupPolicy_ReturnsOk()
    {
        // Arrange
        const long scopedIdentity = 8;
        SetUserClaims();
        var request = new PostGroupPolicy()
        {
            PartnersId = 5,
            AgentsId = 1,
            SubAgentsId = 2,
        ...
        _mockTransactionV1Service.Setup(s => s.PostGroupPolicy(It.IsAny<object>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((object _, CancellationToken _) => TransactionResult<PostId>.Success(new PostId { Id = scopedIdentity }));

        // Act
        var result = await _controller.PostGroupPolicy(request);
    ...
    [Fact]
    public async Task PostGroupPolicy_ReturnsBadRequest_WhenValidationFails()
    {
        // Arrange
        SetUserClaims();
        var request = new PostGroupPolicy()
    ...
    [Fact]
    public async Task PostGroupPolicy_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        var request = new PostGroupPolicy()
    ...
    [Fact]
    public async Task PostGroupPolicy_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var request = new PostGroupPolicy()
    ...
    [Fact]
    public async Task PostGroupPolicy_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        var request = new PostGroupPolicy()
    ...
    [Fact]
    public async Task PostGroupPolicy_ReturnsUnauthorized()
    {
        // Arrange
