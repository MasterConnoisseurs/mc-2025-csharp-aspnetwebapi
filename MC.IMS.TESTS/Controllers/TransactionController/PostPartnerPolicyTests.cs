...
public class PostPartnerPolicyTests
{
    ...
    [Fact]
    public async Task PostPartnerPolicy_ReturnsOk()
    {
        // Arrange
        const long scopedIdentity = 1;
        SetUserClaims();
        var request = new PostPartnerPolicy()
        {
            PartnersId = 5,
            AgentsId = 1,
            SubAgentsId = null,
        ...
        _mockTransactionV1Service.Setup(s => s.PostPartnerPolicy(It.IsAny<object>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((object _, CancellationToken _) => TransactionResult<PostId>.Success(new PostId { Id = scopedIdentity }));

        // Act
        var result = await _controller.PostPartnerPolicy(request);
    ...
    [Fact]
    public async Task PostPartnerPolicy_ReturnsBadRequest_WhenValidationFails()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPartnerPolicy()
    ...
    [Fact]
    public async Task PostPartnerPolicy_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPartnerPolicy()
    ...
    [Fact]
    public async Task PostPartnerPolicy_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPartnerPolicy()
    ...
    [Fact]
    public async Task PostPartnerPolicy_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        var request = new PostPartnerPolicy()
    ...
    [Fact]
    public async Task PostPartnerPolicy_ReturnsUnauthorized()
    {
        // Arrange
