...
public class DeletePolicyBeneficiaryTests
{
    ...
    public DeletePolicyBeneficiaryTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "DeletePolicyBeneficiary"
            }
        };
    ...
    [Fact]
    public async Task DeletePolicyBeneficiary_ReturnsOk()
    {
        // Arrange
        SetUserClaims();
        ...
        // Act
        var result = await _controller.DeletePolicyBeneficiary(scopedIdentity);
    ...
    [Fact]
    public async Task DeletePolicyBeneficiary_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 10;
    ...
    [Fact]
    public async Task DeletePolicyBeneficiary_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 10;
    ...
    [Fact]
    public async Task DeletePolicyBeneficiary_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 10;
    ...
    [Fact]
    public async Task DeletePolicyBeneficiary_ReturnsUnauthorized()
    {
        // Arrange
