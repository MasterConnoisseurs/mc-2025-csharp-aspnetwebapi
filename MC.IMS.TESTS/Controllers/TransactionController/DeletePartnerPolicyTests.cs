...
public class DeletePartnerPolicyTests
{
    ...
    public DeletePartnerPolicyTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "DeletePartnerPolicy"
            }
        };
    ...
    [Fact]
    public async Task DeletePartnerPolicy_ReturnsOk()
    {
        // Arrange
        SetUserClaims();
        ...
        // Act
        var result = await _controller.DeletePartnerPolicy(scopedIdentity);
    ...
    [Fact]
    public async Task DeletePartnerPolicy_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 1;
    ...
    [Fact]
    public async Task DeletePartnerPolicy_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 1;
    ...
    [Fact]
    public async Task DeletePartnerPolicy_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        const long scopedIdentity = 1;
    ...
    [Fact]
    public async Task DeletePartnerPolicy_ReturnsUnauthorized()
    {
        // Arrange
