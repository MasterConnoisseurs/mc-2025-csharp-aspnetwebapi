...
public class GetPartnerPolicyTests
{
    ...
    [Fact]
    public async Task GetPartnerPolicy_ReturnsOk_NoParameters()
    {
        // Arrange
        SetUserClaims();
        _mockTransactionV1Service.Setup(s => s.GetPartnerPolicy(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
            ...
            {
                var filteredList = MockData.Transaction.PartnerPolicy.PartnerPolicyList().Where(x =>
                    (id == null || x.Id == id) &&
        ...
        // Act
        var result = await _controller.GetPartnerPolicy(null, null, null, null, null, null, null, null, null);

        // Assert
        var statusCodeResult = Assert.IsType<OkObjectResult>(result);
        var returnData = Assert.IsAssignableFrom<PagedResponse<IEnumerable<PartnerPolicy>>>(statusCodeResult.Value);
    ...
    [Fact]
    public async Task GetPartnerPolicy_ReturnsOk_WithParameters()
    {
        // Arrange
        SetUserClaims();
        _mockTransactionV1Service.Setup(s => s.GetPartnerPolicy(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
        ...
        // Act
        var result = await _controller.GetPartnerPolicy(1, null, null, null, null, null, null, null, null);
    ...
    [Fact]
    public async Task GetPartnerPolicy_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var resultData = TransactionResult<IEnumerable<PartnerPolicy>>.Failure(new Exception("Service failed"));
        _mockTransactionV1Service.Setup(s => s.GetPartnerPolicy(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
    ...
    [Fact]
    public async Task GetPartnerPolicy_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        _mockTransactionV1Service.Setup(s => s.GetPartnerPolicy(It.IsAny<long?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<long?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>(), It.IsAny<int>(), It.IsAny<int>()))
    ...
    [Fact]
    public async Task GetPartnerPolicy_ReturnsUnauthorized()
    {
        // Arrange
