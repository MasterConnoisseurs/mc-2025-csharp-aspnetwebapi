...
public class PutIndividualPolicyTests
{
    ...
    public PutIndividualPolicyTests()
    {
        ...
        var controllerContext = new ControllerContext
        {
            ...
            {
                ActionName = "PutIndividualPolicy"
            }
        };
    ...
    [Fact]
    public async Task PutIndividualPolicy_ReturnsOk()
    {
        // Arrange
        SetUserClaims();
        ...
        _mockTransactionV1Service.Setup(s => s.PutIndividualPolicy(It.IsAny<object>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((object _, CancellationToken _) => TransactionResult.Success());

        // Act
        var result = await _controller.PutIndividualPolicy(request);
    ...
    [Fact]
    public async Task PutIndividualPolicy_ReturnsBadRequest_WhenValidationFails()
    {
        // Arrange
        SetUserClaims();
        var request = new PutIndividualPolicy()
    ...
    [Fact]
    public async Task PutIndividualPolicy_ReturnsBadRequest_WhenCustomSQLExceptionIsFound()
    {
        // Arrange
        SetUserClaims();
        var request = new PutIndividualPolicy()
    ...
    [Fact]
    public async Task PutIndividualPolicy_ReturnsInternalServerError()
    {
        // Arrange
        SetUserClaims();
        var request = new PutIndividualPolicy()
    ...
    [Fact]
    public async Task PutIndividualPolicy_ReturnsRequestTimeout()
    {
        // Arrange
        SetUserClaims();
        var request = new PutIndividualPolicy()
    ...
    [Fact]
    public async Task PutIndividualPolicy_ReturnsUnauthorized()
    {
        // Arrange
